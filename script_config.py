...
SITE_PATH: str = "/sites/YourSiteName"     # the bit after the hostname
SITE_ID: str = ""                          # optional, skips resolution
...
DRIVE_ID: str = ""                         # optional, skips resolution
...
def main() -> int:
    ...
    if SHAREPOINT_ENABLED:
        ...
        try:
            ...
            print(f"  The CSV is still saved locally at {output_path}")
            return 4
        except requests.exceptions.RequestException as exc:
            print(f"  UPLOAD FAILED (network): {exc}")
            print(f"  The CSV is still saved locally at {output_path}")
            return 4
